...
export const HpcoTest = (props) => {
  const [show, setShow] = useState(false);
  const [tests, setTests] = useState(
    props.testData.Tests.find((x) => x.Name === "HPCO_TEST").Value
  );
  ...
  const handleChange = (propertyName, value) => {
    ...
    setTests({
      ...copiedTestData.Tests.find((x) => x.Name === "HPCO_TEST").Value,
    });
  };
                ...
                <div className="grid-val">
                  ...
                  <div>
                    <input
                      ...
                      min="0"
                      className="input"
                      value={tests.Default_HPCO_Test.Cycle_Time}
                      onChange={(e) =>
                        handleChange(
                          "Default_HPCO_Test.Cycle_Time",
                          e.target.value
                        )
                      }
                    />
                ...
                <div className="grid-val">
                  ...
                  <div>
                    <input
                      ...
                      min="0"
                      className="input"
                      value={tests.Default_HPCO_Test.Maximum_System_Flow}
                      onChange={(e) =>
                        handleChange(
                          "Default_HPCO_Test.Maximum_System_Flow",
                          e.target.value
                        )
                      }
                    />
                ...
                <div className="grid-val">
                  ...
                  <div>
                    <input
                      ...
                      min="0"
                      className="input"
                      value={tests.Default_HPCO_Test.Maximum_System_Pressure}
                      onChange={(e) =>
                        handleChange(
                          "Default_HPCO_Test.Maximum_System_Pressure",
                          e.target.value
                        )
                      }
                    />
