...
export const KickoutTest = (props) => {
  const [show, setShow] = useState(false);
  const [tests, setTests] = useState(
    props.testData.Tests.find((x) => x.Name === "KickOut_Test").Value
  );
  ...
  const handleChange = (propertyName, value) => {
    ...
    setTests({
      ...copiedTestData.Tests.find((x) => x.Name === "KickOut_Test").Value,
    });
  };
        ...
        <div>
          ...
          {show && (
            ...
            >
                ...
                <div className="grid-val">
                  ...
                  <div>
                    <input
                      ...
                      min="0"
                      className="input"
                      value={tests.Default_KO_Test.Cycle_Time}
                      onChange={(e) =>
                        handleChange(
                          "Default_KO_Test.Cycle_Time",
                          e.target.value
                        )
                      }
                    />
                ...
                <div className="grid-val">
                  ...
                  <div>
                    <input
                      ...
                      min="0"
                      className="input"
                      value={tests.Default_KO_Test.Maximum_System_Flow}
                      onChange={(e) =>
                        handleChange(
                          "Default_KO_Test.Maximum_System_Flow",
                          e.target.value
                        )
                      }
                    />
                ...
                <div className="grid-val">
                  ...
                  <div>
                    <input
                      ...
                      min="0"
                      className="input"
                      value={tests.Default_KO_Test.Maximum_System_Pressure}
                      onChange={(e) =>
                        handleChange(
                          "Default_KO_Test.Maximum_System_Pressure",
                          e.target.value
                        )
                      }
                    />
              ...
              >
                <div style={{ "font-weight": "600" }}>HPCO Line</div>
                <hr />
                <div>
                  <div className="grid-val">
